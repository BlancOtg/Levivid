...
const baseMovies = [
  {
    ...
    runtime: 143,
    overview:
      "Earth's mightiest heroes must come together to save the world from destruction.",
    vote_average: 8.5,
    vote_count: 15000,
  ...
  },
  {
    ...
    backdrop_path: null,
    overview:
      "A heartwarming tale of a dog and his owner's journey across the country.",
    vote_average: 7.8,
    vote_count: 3200,
    runtime: 143,
...
export const movies = Array.from({ length: 50 }, (_, index) => {
  ...
  return {
    ...
    id: index + 1,
    vote_average: Number(
      (baseMovie.vote_average + (Math.random() * 0.4 - 0.2)).toFixed(1),
    ),
